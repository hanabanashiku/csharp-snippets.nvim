...
local function is_nunit_legacy() return context.get_test_library() == "NUnit.Framework.Legacy" end

local function is_xunit() return context.get_test_library() == "XUnit" end

local function is_mstest() return context.get_test_library() == "MSTest" end
...
local aaa = s({
    ...
    show_condition = function() return context.get_test_library() ~= nil and context.is_in_block() end,
})
...
local nunit_fixture = s(
    ...
    {
        show_condition = function() return (is_nunit() or is_nunit_legacy()) and can_create_fixture() end,
    }
)
...
table.insert(
    ...
    public void <identifier>()
    {
        ...
        {
            show_condition = function() return (is_nunit() or is_nunit_legacy()) and context.is_in_class() end,
        }
    )
)
...
table.insert(
    ...
    public async Task <identifier>()
    {
        ...
        {
            show_condition = function() return is_nunit and context.is_in_class() end,
        }
    )
)
...
for _, assert in ipairs(asserts) do
    table.insert(
        ...
        s({
            ...
            show_condition = function() return is_nunit() and context.is_in_block() end,
        })
    )
    ...
    table.insert(
        ...
        s({
            ...
            show_condition = function() return is_nunit_legacy() and context.is_in_block() end,
        })
    )
end
